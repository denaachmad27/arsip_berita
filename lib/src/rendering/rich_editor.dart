          ...
          child: InAppWebView(
            ...
            onLoadStop: (controller, link) async {
              ...
              if (link!.path != 'blank') {
                ...
                await javascriptExecutor.refreshHeight();
                  ...
                  callback: (args) {
                    ...
                    try {
                      ...
                      if (controller.hasClients) {
                        ...
                        final factor = 0.9; // allow slightly more momentum

                        final target = (controller.position.pixels + delta * factor)
